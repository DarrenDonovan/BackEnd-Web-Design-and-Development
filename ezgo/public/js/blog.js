...
function like(id) {
    ...
    let amount = document.getElementById("count" + id).innerText;
    if (amount == null) {
        amount = "0";
    }
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.success) {
                ...
                html += '<div class="bg-white mb-3" style="padding: 30px;">';
                html += '<div class="d-flex mb-3">';
                html +=
                    '<a class="text-primary text-uppercase text-decoration-none" href="">' +
                    blog.cName +
                ...
                html += '<div class="col mb-4 pb-2">';
                html +=
                    '<div id="cmt' + blog.blogID + 'div" class="bg-white p-4">';

                html += "<h4>Comments</h4>";

                response.comment.forEach(function (comm) {
                    html += "<div>";
                    html +=
                        '<p class="font-weight-bold pt-3">' +
                        comm.cName +
                        "</p>";
                    html += "<p>" + comm.ctContent + "</p>";
                    html += "</div>";
                });
